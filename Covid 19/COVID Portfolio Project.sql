...
-- Using Common Table Expression (CTE) or a subquery to calculate it first before using it in the calculation for 'PercentPopulationVaccinated'.
...
-- Temp Table to calculate the rolling sum of vaccinations and percentage of population vaccinated
